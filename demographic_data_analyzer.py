...
def calculate_demographic_data():
    ...
    country_stats['percentage_rich'] = country_stats['>50K'] * 100
    highest_earning_country = country_stats['percentage_rich'].idxmax()
    highest_earning_country_percentage = round(country_stats['percentage_rich'].max(), 1)
